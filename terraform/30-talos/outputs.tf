output "kubeconfig" {
  description = "Kubeconfig for the Talos cluster. Consumed by layer 40-apps via terraform_remote_state."
...
output "node_storage_ips" {
  description = "Node name -> eth1 storage IP (VLAN 12); 40-apps excludes these from the whereabouts range."
